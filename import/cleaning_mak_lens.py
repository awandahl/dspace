...
#df_lens = pd.read_csv("smak_lens_export.txt", delimiter=',', quotechar='"', index_col=False, na_filter=False, encoding='utf-8') ## import with nothing instead of NaN
df_lens = pd.read_csv("lens-export.csv", delimiter=',', quotechar='"', index_col=False, na_filter=False, encoding='utf-8') ## import with nothing instead of NaN
...
df_lens['Keywords'].replace({'\\r\\n': ' ','\\n': ' ', '\\r': ' ', '\\t': ' ', '\\s{2,}': ' ', u'\u2010': '-'}, inplace=True, regex=True)
...
df_lens['Title'].replace({'\\r\\n': ' ','\\n': ' ', '\\r': ' ', '\\t': ' ', '\\s{2,}': ' ', u'\u2010': '-'}, inplace=True, regex=True)
df_lens['Author/s'].replace({'\\r\\n': ' ','\\n': ' ', '\\r': ' ', '\\t': ' ', '\\s{2,}': ' ', u'\u2010': '-'}, inplace=True, regex=True)
df_lens['Abstract'].replace({'\\r\\n': ' ','\\n': ' ', '\\r': ' ', '\\t': ' ', '\\s{2,}': ' ', u'\u2010': '-'}, inplace=True, regex=True)
df_lens['Issue Number'].replace({'\\r\\n': ' ','\\n': ' ', '\\r': ' ', '\\t': ' ', '\\s{2,}': ' ', u'\u2010': '-'}, inplace=True, regex=True)  
...
## Making CSVs
df_lens.to_csv(r'lens_out.csv', index=False, encoding='utf-8')
df_lens_source.to_csv(r'mak_lens_source_out.csv', index=False, encoding='utf-8')
df_lens_no_source.to_csv(r'mak_lens_no_source_out.csv', index=False, encoding='utf-8')
df_lens_preprint.to_csv(r'mak_lens_preprint_out.csv', index=False, encoding='utf-8')
df_lens_no_source_doi.to_csv(r'mak_lens_no_source_doi_out.csv', index=False, encoding='utf-8')
